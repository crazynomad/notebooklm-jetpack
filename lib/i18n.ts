...
const zh = {
  ...
  'more.backupTitle': '数据备份与迁移',
  'more.backupDesc': '导出收藏、收藏集、导入历史和设置为 JSON，或从备份恢复',
  'more.exportData': '导出数据',
  'more.importData': '导入数据',
  'more.exportSuccess': '数据已导出',
  'more.exportFailed': '导出失败',
  'more.importMergeTitle': '选择导入方式',
  'more.importMerge': '合并',
  'more.importMergeDesc': '保留现有数据，加入备份中的新条目',
  'more.importOverwrite': '覆盖',
  'more.importOverwriteDesc': '用备份内容替换现有数据',
  'more.importSuccessMsg': '已导入 {count} 项数据',
  'more.importFailed': '导入失败：文件无效或版本不兼容',
  'more.importConfirmOverwrite': '覆盖将替换现有的收藏、历史和设置，确定继续？',
  'more.importOverwriteConfirmBtn': '确认覆盖导入',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'more.backupTitle': 'Backup & migrate data',
  'more.backupDesc': 'Export bookmarks, collections, import history and settings as JSON, or restore from a backup',
  'more.exportData': 'Export data',
  'more.importData': 'Import data',
  'more.exportSuccess': 'Data exported',
  'more.exportFailed': 'Export failed',
  'more.importMergeTitle': 'Choose import mode',
  'more.importMerge': 'Merge',
  'more.importMergeDesc': 'Keep existing data, add new items from the backup',
  'more.importOverwrite': 'Overwrite',
  'more.importOverwriteDesc': 'Replace existing data with the backup contents',
  'more.importSuccessMsg': 'Imported {count} data items',
  'more.importFailed': 'Import failed: invalid file or incompatible version',
  'more.importConfirmOverwrite': 'Overwrite will replace your existing bookmarks, history and settings. Continue?',
  'more.importOverwriteConfirmBtn': 'Confirm overwrite',
